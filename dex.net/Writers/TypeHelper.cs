...
namespace dex.net
{
	public class TypeHelper
	{
		...
		internal string EncodedValueToString (EncodedValue value, Class currentClass)
		{
		...
		internal string AccessFlagsToString (AccessFlag flag)
		{
		...
		internal string AccessAndType(Class dexClass) {
